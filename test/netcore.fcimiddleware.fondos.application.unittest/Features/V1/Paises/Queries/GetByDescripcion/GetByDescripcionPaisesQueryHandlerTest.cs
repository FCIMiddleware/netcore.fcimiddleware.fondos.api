...
namespace netcore.fcimiddleware.fondos.application.unittest.Features.V1.Paises.Queries.GetByDescripcion
{
    public class GetByDescripcionPaisesQueryHandlerTest
    {
        private readonly IMapper _mapper;
        private readonly Mock<UnitOfWork> _unitOfWork;
        private readonly Mock<ILogger<GetByDescripcionPaisesQueryHandler>> _logger;
        private CancellationToken _cancellationToken;
        private GetByDescripcionPaisesQueryHandler _handler;

        public GetByDescripcionPaisesQueryHandlerTest()
        {
            ...
            _logger = new Mock<ILogger<GetByDescripcionPaisesQueryHandler>>();
            MockDataRepository.AddDataRepository(_unitOfWork.Object);
            _handler = new GetByDescripcionPaisesQueryHandler(_logger.Object, _mapper, _unitOfWork.Object);
            _cancellationToken = CancellationToken.None;
        }

        [Fact]
        public async Task GetByDescripcionPaisTest_Return_Ok()
        {
            var request = new GetByDescripcionPaisesQuery
            {
                PageIndex = 1,
                PageSize = 10,
                Search = "",
            ...
            result.ShouldBeOfType<PaginationVm<PaisListVm>>();
        }
