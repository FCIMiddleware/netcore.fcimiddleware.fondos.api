...
namespace netcore.fcimiddleware.fondos.application.unittest.Features.V1.SocGerentes.Queries.GetAll
{
    public class GetAllSocGerentesQueryHandlerTest
    {
        private readonly IMapper _mapper;
        private readonly Mock<UnitOfWork> _unitOfWork;
        private readonly Mock<ILogger<GetAllSocGerentesQueryHandler>> _logger;
        private CancellationToken _cancellationToken;
        private GetAllSocGerentesQueryHandler _handler;

        public GetAllSocGerentesQueryHandlerTest()
        {
            ...
            _logger = new Mock<ILogger<GetAllSocGerentesQueryHandler>>();
            MockDataRepository.AddDataRepository(_unitOfWork.Object);
            _handler = new GetAllSocGerentesQueryHandler(_logger.Object, _mapper, _unitOfWork.Object);
            _cancellationToken = CancellationToken.None;
        }

        [Fact]
        public async Task GetAllSocGerentesTest_Return_Ok()
        {

            var request = new GetAllSocGerentesQuery
            {
                PageIndex = 1,
                PageSize = 10,
                Search = "",
            ...
            result.ShouldBeOfType<PaginationVm<SocGerenteVm>>();
        }
